...
void ui_ProfileScreen_screen_init(void) {
    ...
    ui_object_set_themeable_style_property(ui_ProfileScreen_ImgButton1, LV_PART_MAIN | LV_STATE_DEFAULT, LV_STYLE_IMG_RECOLOR,
                                           _ui_theme_color_NiceWhite);
    ui_object_set_themeable_style_property(ui_ProfileScreen_ImgButton1, LV_PART_MAIN | LV_STATE_DEFAULT, LV_STYLE_IMG_RECOLOR_OPA,
    ...
    ui_object_set_themeable_style_property(ui_ProfileScreen_loadingSpinner, LV_PART_INDICATOR | LV_STATE_DEFAULT,
                                           LV_STYLE_ARC_OPA, _ui_theme_alpha_NiceWhite);
    ...
    ui_ProfileScreen_targetDuration2 = lv_label_create(ui_ProfileScreen_profileDetails);
