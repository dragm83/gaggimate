...
lv_obj_t *ui_MenuScreen_dials = NULL;
lv_obj_t *ui_MenuScreen_standbyButton = NULL;
lv_obj_t *ui_MenuScreen_contentPanel1 = NULL;
lv_obj_t *ui_MenuScreen_btnBrew = NULL;
...
void ui_MenuScreen_screen_init(void) {
    ...
    ui_object_set_themeable_style_property(ui_MenuScreen_standbyButton, LV_PART_MAIN | LV_STATE_DEFAULT,
    ...
    ui_object_set_themeable_style_property(ui_MenuScreen_btnBrew, LV_PART_MAIN | LV_STATE_DEFAULT,
    ...
    ui_object_set_themeable_style_property(ui_MenuScreen_btnSteam, LV_PART_MAIN | LV_STATE_DEFAULT, LV_STYLE_BG_IMG_RECOLOR,
                                           _ui_theme_color_NiceWhite);
    ui_object_set_themeable_style_property(ui_MenuScreen_btnSteam, LV_PART_MAIN | LV_STATE_DEFAULT,
                                           LV_STYLE_BG_IMG_RECOLOR_OPA, _ui_theme_alpha_NiceWhite);
    ...
    ui_object_set_themeable_style_property(ui_MenuScreen_waterBtn, LV_PART_MAIN | LV_STATE_DEFAULT, LV_STYLE_BG_IMG_RECOLOR,
                                           _ui_theme_color_NiceWhite);
    ui_object_set_themeable_style_property(ui_MenuScreen_waterBtn, LV_PART_MAIN | LV_STATE_DEFAULT,
                                           LV_STYLE_BG_IMG_RECOLOR_OPA, _ui_theme_alpha_NiceWhite);
    ...
    ui_object_set_themeable_style_property(ui_MenuScreen_grindBtn, LV_PART_MAIN | LV_STATE_DEFAULT, LV_STYLE_BG_IMG_RECOLOR,
                                           _ui_theme_color_NiceWhite);
    ui_object_set_themeable_style_property(ui_MenuScreen_grindBtn, LV_PART_MAIN | LV_STATE_DEFAULT,
                                           LV_STYLE_BG_IMG_RECOLOR_OPA, _ui_theme_alpha_NiceWhite);
    ...
    uic_MenuScreen_dials_weightText = ui_comp_get_child(ui_MenuScreen_dials, UI_COMP_DIALS_WEIGHTTEXT);
...
void ui_MenuScreen_screen_destroy(void)
{
    ...
    ui_MenuScreen = NULL;
    ui_MenuScreen_dials = NULL;
    uic_MenuScreen_dials_tempGauge = NULL;
    uic_MenuScreen_dials_tempTarget = NULL;
    uic_MenuScreen_dials_pressureGauge = NULL;
    uic_MenuScreen_dials_pressureTarget = NULL;
    uic_MenuScreen_dials_pressureText = NULL;
    uic_MenuScreen_dials_tempText = NULL;
    uic_MenuScreen_dials_weightText = NULL;
    ui_MenuScreen_standbyButton = NULL;
    ui_MenuScreen_contentPanel1 = NULL;
    ui_MenuScreen_btnBrew = NULL;
